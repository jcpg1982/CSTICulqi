package com.csticorp.culqi.test.di
...
import com.csticorp.culqi.test.data.repository.WebService
...
object NetWorkModule {
    ...
    @Provides
    @Singleton
    fun provideDataSourceRemote(webService: WebService) = Repository(webService)
}